...
// Closed Hash table class - for all classes: Linear, Quadratic, Double
//
...
public:
    explicit LinearHashTable( int size = 10007 ) : array( nextPrime( size ) )
    { makeEmpty( ); }
...
// ---- end of LinearHahingTable Class ----------------------------------------------------------------------

// ---- QuadProbingTable ------------------------------------------------------------------------------------

class QuadProbingTable
{
    
public:
    explicit QuadProbingTable( int size = 10007 ) : array( nextPrime( size ) )
    { makeEmpty( ); }
...
public:
    explicit DoubleHashTable( int size = 10007 ) : array( nextPrime( size ) )
    { makeEmpty( ); }
